...
#### *Want to learn more?*
This blog post is awesome, but you'll learn a lot more from a book than from me... If you're interested in learning more about object detection and segmentation, check out these books on Amazon:
...
Though *Mask R-CNN* seems to work really well out of the box, it is also pretty slow.  It took about 8 seconds to score a single image on my Mac, while consuming all 8 CPU cores. So, if speed is important to you, you may consider alternatives, or utilize a GPU. [*YOLO*](https://pjreddie.com/darknet/yolo/) is one option that can perform object detection in real time:
